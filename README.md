...
***Dataclasses***, before of Pydantic, was in Python simplify the creation of data structures with minimal code, and gives you a lot of useful utility right out of the box.
Para visitar la documentacion oficial: https://docs.python.org/3/library/dataclasses.html.

Para ver un video explicacion sobre DataClasses en youtube:
https://youtu.be/9B9CdKANjnM?si=r6qEb3TTdLOhjA23
...
Para ver un video explicacion sobre pydantic en youtube:
